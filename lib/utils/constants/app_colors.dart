...
const Color kprimaryColor = Color(0xff00BE84);
const Color kdarkColor = Color(0xFF121212);
const Color pinkColor = Color(0xFFff4667);
const Color kbrown = Color(0xff685959);
const Color kgreyWhite = Color(0xffADA79B);
